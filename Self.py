...
cl = TOBY.LINE()
cl.login(token="EnN1EBJm2M80vH2Fjst1.iU0HVzEKkrCM/Lo3vS4Vaq.rXuLKTDa7v3S8d7gI2PLsOvGyd8bF4bxpIvJbMUKTXo=")
cl.loginResult()
...
==================================================
BOT : SYNDICATE
SUPPORT BY : SMULE INDONESIA FAMILY
...
creator=["u22ed21bd97a4291726fa53b756ce2f01"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~chiqaladiksa",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~chiqaladiksa",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
				...
				if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to, "Progress Checking sider........."),
                    try:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Aman gk aman yg penting anu boss")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Selamat datang di BiG SiF Familly")
					cl.sendText(msg.to,"Budayakan Baca Note ya Kakak ")
#-----------------------------------------------
			...
			for zx in range(0,100):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Like Back Atuh")
						print "DiLike"
					except:
							pass
				else:
